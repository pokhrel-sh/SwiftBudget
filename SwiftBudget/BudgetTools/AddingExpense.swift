...
class ViewController: UIViewController {
    ...
    private func setupExpenseAmountTextField() {
        ...
        view.addSubview(expenseAmountTextField)
    }
    ...
    private func setupExpenseNameLabel() {
        ...
        view.addSubview(expenseNameLabel)
    }
    ...
    private func setupExpenseDescriptionLabel() {
        ...
        view.addSubview(expenseDescriptionLabel)
    }
    ...
    private func setupExpenseDescriptionTextField() {
        ...
        view.addSubview(expenseDescriptionTextField)
    }
    ...
    private func setupViewAllExpensesButton() {
        ...
        view.addSubview(viewAllExpensesButton)
    }
    
    private func initConstraints() {
        NSLayoutConstraint.activate([
            // Expense Title
            expenseTitle.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20),
            ...
            addExpenseLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            
            // Expense Amount TextField
            expenseAmountTextField.topAnchor.constraint(equalTo: addExpenseLabel.bottomAnchor, constant: 10),
            expenseAmountTextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            expenseAmountTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            ...
            expenseNameLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            
            // Expense Name TextField
            expenseNameTextField.topAnchor.constraint(equalTo: expenseNameLabel.bottomAnchor, constant: 10),
            expenseNameTextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            expenseNameTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            ...
            expenseDescriptionLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            ...
            expenseDescriptionTextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            expenseDescriptionTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            ...
            viewAllExpensesButton.centerXAnchor.constraint(equalTo: view.centerXAnchor)
        ])
    }
}
